...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" lang="fr">
	...
	<body>
		...
		<div class="row-fluid">
			<div class="span12">
				<p><span id="ancre"><a href="#">Accueil > </a></span><strong>Gestion pattern</strong></p>
			</div>
		</div>
					...
					<div class="span6">
						<fieldset>
							...
							<label for="last version" class="radio inline">Last Version Only</label>
								<input type="radio" name="origine" value="last version" id="last version"/>
							<label for="all version" class="radio inline">All version</label>
								<input type="radio" name="origine" value="all version" id="all version"/><br/>
							<p>
